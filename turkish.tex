...
\noindent \textbf{Egzersiz 2-1.} \textbf{char}, \textbf{short}, \textbf{int} ve \textbf{long} gibi değişkenlerin (\textbf{variables}) hem \textbf{signed} hem \textbf{unsigned} için, genişliğini standard başlıklardan (\textbf{header}) uygun değerleri (\textbf{values}) bastıran direkt hesaplayan bir program yazınız. Eğer yazacağınız program hesaplayacak ise daha da zor olacaktır: bir çok kayar noktalı tipin (\textbf{type}) genişliğini belirleyiniz.
