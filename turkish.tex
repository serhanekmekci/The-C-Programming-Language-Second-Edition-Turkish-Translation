...
\newline
\par Bu noktada, geleneksel olarak C'nin temeli olan bahsedilen şeyi kavramış bulunmaktayız. Bu bir avuç blok inşâsı ile, belli bir boyuttaki programları yazmak mümkün, ve eğer bunu yapmak için yeterince ara verdiyseniz bu muhtemelen iyi bir fikirdi. Bu egzersizler bu bölümdeki programların daha kompleks hallerini öneriyor.
\end{document}
